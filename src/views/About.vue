...
<template>
  <div class="container">
    <div class="flex justify-center items-center min-h-[75vh] px-xs py-md">
      <div
        class="p-md md:px-lg md:py-xl bg-dark-3 max-w-screen-lg rounded-md drop-shadow-md"
      >
        <div
        ...
        >
          <div>
            <img
              ...
              class="aspect-square rounded-full border-4 border-light-3 w-full min-w-[256px] max-w-[384px]"
              width="256"
              height="256"
            />
          </div>
          <div class="text-light-3">
            <h2 class="h2-md mb-xs">About Typesense Search</h2>
            <div class="font-bold text-lg mb-xs">
              <p>
                A Proof of Concept project for integrating typesense for
                searching different collections of data.
              </p>
              <p>Version: 0.1.0</p>
              <p>Maintainer: Sihun Kim</p>
            </div>
            <div class="flex items-center justify-center gap-xs">
              ...
              <a
                ...
                class="p-3xs rounded-md bg-light-1 text-dark-3 hover:bg-opacity-75 transition-colors duration-300 ease-linear"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
